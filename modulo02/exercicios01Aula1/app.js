...
const my3FavoriteTVShows = ['The Good Doctor', 'Doctor House', 'The Witcher']
const sentece = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(', ').replace(', T', ' e T')}.`
// console.log(sentece)
...
// console.log(`A string que a "typeSentence" armazena tem mais de ${toCheckNumber} caracteres? ${String(typeSentence.length > toCheckNumber).replace('t', 'T')}.`)
...
// quando null esta em volvido em uma operação matematica o 'null' se comporta como '0'
// então o resultado da soma é '1' e um não é um valor FALSY por isso é TRU
