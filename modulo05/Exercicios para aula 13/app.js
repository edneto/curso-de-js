...
//   if (number % 2 === 0) {
//     ul.innerHTML += `<li class = "number colorPair">${number}</li>`

//   } else {
//     ul.innerHTML += `<li class = "number colorOdd">${number}</li>`
//   }
// })
...
//const body = document.querySelector('body')// formas de ver a referência do body
const body = document.body //outra forma de pegara referência
...
console.log(repoLink.getAttribute("href"))// outra forma de exibir conteúdo
