...
const lis = Array.from(ul.children) //converte HTMLCollection em NodeList
...
const insertVideoLi = ({ name, length }) => { //usando destructuring assignment
  ul.innerHTML += `<li>${name} Time: ${length}</li>`
}
