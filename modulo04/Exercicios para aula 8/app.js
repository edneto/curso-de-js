...
// ele não encontrou a declaração da variável 'AGE', 
//pois a mesma foi declarada no escopo local
// e assim não tem como ser vista no escopo global
...
const car = {
  name: 'Fusca',
  brand: 'Volkswagen',
  colors: ['Roxo Mirtilo', 'Azul Techno', 'Amarelo Citrus'],
  isRunning: false,
  run() {
    this.isRunning = true
